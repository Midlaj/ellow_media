...
include("include/dbconnect.php");                              
    ...
    $id=$_GET['id'];
    $stm = $link->prepare("SELECT * FROM tbl_available WHERE  pk_int_available_id = $id");
    $stm->execute();
    $rw=$stm->fetch();
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
                <div class="row">
                    ...
                    <form method="post" action="update_available.php" enctype="multipart/form-data">
                    
                    <div class="form-group">
                        <label>Image</label>
                        <?php  $img=$rw['vchr_available_pic']; 
                        if(!empty($img)){ 
                        ?>
                            <img src="uploads/available/<?php echo $img ?>" width="110" height="80" /><br />
                        <?php } ?>
