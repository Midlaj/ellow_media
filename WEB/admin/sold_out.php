          ...
          <div class="row">
            <div class="col-md-6">
              <div class="box-primary">
                ...
                <form method="post" action="save_sold.php" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="col-md-6">
              <div class="box-warning">
                <ul class="pagination">
                  <li>
                  <?php
                    $stm = $link->prepare("SELECT count(pk_int_sold_id) as cnt FROM tbl_sold");
                    $stm->execute();
                    $rw1=$stm->fetch();
                    //echo $img['vchr_place'];
          
                    $totalrow= (int)$rw1['cnt'];
                    $stm = $link->prepare("SELECT * FROM tbl_sold");
                    $stm->execute();
                    while ($rw=$stm->fetch()) 
                    {
                  ?>
                  <div class="clearfix"></div>
                    <div class="lastresult">
                      <div class="col-md-3">
                      <img class="featurette-image img-responsive" src="<?php echo $UPLOAD_PATH."sold/".$rw['vchr_sold_pic'];?>">
                      </div>
                      <div class="col-md-7">
                      <?php echo $rw['vchr_title']; ?>
                      </div>
                      <div class="col-md-2">
                      <a class="" href="edit_sold.php?id=<?php echo $rw['pk_int_sold_id']; ?>" role="button">
                      <span class="glyphicon glyphicon-edit"></span></a><br>
                      <a class="" href="delete_sold.php?id=<?php echo $rw['pk_int_sold_id']; ?>">
